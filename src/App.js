...
export default class App extends Component {
  ...
  sortWeight = () => {
    let records = [...this.state.records];
    records.sort( (recordA,recordB) => recordA.weigth - recordB.weigth); 
    this.setState({records})
  }

  sortDate = () => {
    let records = [...this.state.records];
    records.sort( (recordA,recordB) => recordB.weigth - recordA.weigth); 
    this.setState({records})
  }
      ...
      <View style={styles.container}>
        ...
        <View style={styles.records}>
          <View style={styles.recordsBar}>
            <TouchableHighlight>
              <Text style={styles.touchableBarText} onPress={this.sortWeight}>PESO</Text>
            </TouchableHighlight>
            <TouchableHighlight>
              <Text style={styles.touchableBarText} onPress={this.sortDate}>FECHA</Text>
          </TouchableHighlight>
          </View>
